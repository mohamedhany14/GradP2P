...
class DonationsScreen extends StatelessWidget {
  final DonationsControllerImp controller = Get.put(DonationsControllerImp());
            ...
            children: [
                                ...
                                () => Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Image.asset(
                                        controller.donationsList[index]
                                            ['imageUrl'],
                                      ),
                                    ),
                                    Text(
                                      controller.donationsList[index]['text'],
              ...
              Obx(() => Visibility(
                    visible: controller.current.value <
                        controller.donationsList.length,
                    child: Form(
