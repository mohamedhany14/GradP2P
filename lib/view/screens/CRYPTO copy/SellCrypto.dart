...
import 'package:gradp2p/controller/crypto/sellCrypto_controller.dart';
...
class Sellcrypto extends StatelessWidget {
  final SellcryptoControllerImp controller = Get.put(SellcryptoControllerImp());

  Sellcrypto({super.key});
