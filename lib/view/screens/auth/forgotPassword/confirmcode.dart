...
import 'package:gradp2p/controller/auth/forgotPassword/confirmCode_controller.dart';
...
class Confirmcode extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ConfirmcodecontrollerImp controller = Get.put(ConfirmcodecontrollerImp());
    return Scaffold(
