...
class RecieveFromPaymentAddress extends StatelessWidget {
  const RecieveFromPaymentAddress({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    RecievebypaymentAdressControllerImp controller =
        Get.put(RecievebypaymentAdressControllerImp());
