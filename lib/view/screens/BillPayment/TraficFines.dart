...
import 'package:gradp2p/controller/BillPayment/TraficFines_controller.dart';
...
class Traficfines extends StatelessWidget {
  final TraficfinesControllerImp controller =
      Get.put(TraficfinesControllerImp());
            ...
            children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        itemCount: controller.TrafficProvidersList.length,
                                ...
                                () => Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Image.asset(
                                        controller.TrafficProvidersList[index]
                                            ['imageUrl'],
                                      ),
                                    ),
                                    Text(
              ...
              Obx(() => Visibility(
                    visible: controller.current.value <
                        controller.TrafficProvidersList.length,
                    child: Form(
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    Text(
                                      controller.TrafficProvidersList[
