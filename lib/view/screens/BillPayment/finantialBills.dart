...
import 'package:gradp2p/controller/BillPayment/finantial_controller.dart';
...
class Finantialbills extends StatelessWidget {
  final FinantialControllerImp controller = Get.put(FinantialControllerImp());
            ...
            children: [
                              ...
                              child: Obx(
                                () => Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      controller.FinancialList[index]['text'],
              ...
              Obx(() => Visibility(
                    visible: controller.current.value <
                        controller.FinancialList.length,
                    child: Form(
