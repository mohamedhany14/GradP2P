...
class Clubsubsribtion extends StatelessWidget {
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        itemCount: controller.ClubsList.length,
                                ...
                                () => Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Image.asset(
                                        controller.ClubsList[index]['imageUrl'],
                                      ),
                                    ),
                                    Text(
                                      controller.ClubsList[index]['text'],
              ...
              Obx(() => Visibility(
                    visible:
                        controller.current.value < controller.ClubsList.length,
                    child: Form(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    CustomAmountfield(
                                      ...
                                      labeltext: controller.ClubsList[controller
